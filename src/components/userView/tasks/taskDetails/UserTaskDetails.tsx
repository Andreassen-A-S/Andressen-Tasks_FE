...
export default function UserTaskDetails({ taskId, onBack }: UserTaskDetailsProps) {
    ...
    return (
        <>
            ...
            {/* Bottom Sheet */}
            <div
                className={`fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-[20px] h-[93vh] flex flex-col border border-[#E8E6E1] shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-transform duration-200 ${isOpen ? "translate-y-0" : "translate-y-full"
                    }`}
